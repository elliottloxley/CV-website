...
export default Vue.extend({
  ...
  props: {
    ...
    exitDirection: {default: Directions.RIGHT, type: Number as PropType<Directions>}, //
    entryDirection: {default: Directions.LEFT, type: Number as PropType<Directions>}, //
    ...
    relativeCoord: {default() :Coordinate { return [0, 0] }, type: Array as unknown as PropType<Coordinate>}, // added to path coords before any calculations
